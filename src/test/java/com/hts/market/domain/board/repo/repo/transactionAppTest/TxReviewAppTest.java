...
////               MemDto.Create dto4 = MemDto.Create.builder()
////                       .memUsername("spring").memPassword("1234").memEmail("spring@gmail.com").memNickname("spring").memIsEnabled(1).build();
...
////  @Test
////    void save(){
////    TxReviewDto.Create dto = TxReviewDto.Create.builder().txReviewNo(1L).reviewNo(1L).build();
